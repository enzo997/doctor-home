...
//     $api['key'] = 'AIzaSyB0Q1DK5pAR0fFGXiXfS0XFNqTLgTcFMCc';
//     return $api;
// }
...
function my_acf_init() {
	...
	acf_update_setting('google_api_key', 'AIzaSyCxKc7Qi6mrryuFznegPClQocgDuvhsY3w');
}
...
//     $remove = array( 'fontselect', 'forecolor' );
//     return array_diff( $buttons, $remove );
// }

function enable_more_buttons($buttons) {
    // , 'styleselect'
    $buttons = array('fontselect', 'fontsizeselect', 'backcolor', 'newdocument', 'cut', 'copy', 'charmap', 'visualaid' );
