jQuery(document).ready(function (a) {
    ...
    769 > jQuery(window).width() && (a(".logo").clone().insertBefore(".header_aera .navbar-nav"), 
...
jQuery(document).ready(function ($) {
    ...
    jQuery('.load_paging').on('click', function(){
        setTimeout(function(){
            jQuery('html, body').animate({
                scrollTop: jQuery(".tab-service--header").offset().top
            }, 800);
        }) 
    })
    ...
    if (jQuery(window).width() > 768) {
        jQuery('.main, .home-page, .post-type-archive .main, .single .main, .tax-danh-muc-dich-vu .main, body > .contact').css('padding-top', header_height + 'px');
    }
    else{
        jQuery('.main, .home-page, .post-type-archive .main, .single .main, .tax-danh-muc-dich-vu .main, body > .contact').css('padding-top', mobile_header_height + 'px');
    }
