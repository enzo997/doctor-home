...
<div class="main">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-service">
                        ...
                        <a href="#" target="_blank" class="service-heading">Bảo Trì Trọn Gói</a>
                        <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                        <a href="#" target="_blank"  class="detail">XEM CHI TIẾT
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-service">
                        ...
                        <a href="#" target="_blank"  class="service-heading">Bảo Trì Nhà Xưởng</a>
                        <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                        <a href="#" target="_blank" class="detail">XEM CHI TIẾT
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-service">
                        ...
                        <a href="#" target="_blank" class="service-heading">Danh Mục Bảo Trì Khác</a>
                        <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                        <a href="#"target="_blank"  class="detail">XEM CHI TIẾT
                            <i class="fa fa-chevron-right" aria-hidden="true"></i>
                        </a>
    ...
    <section class="library-img">
        <div class="container">
            ...
            <div class="see-all">
                <a href="#" target="_blank">XEM TẤT CẢ
                    <i class="fa fa-chevron-right" aria-hidden="true"></i>
                </a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-blog">
                        ...
                        <div class="content-box">
                            <h4>
                                <a href="#" target="_blank" class="title-blog">Tư vấn cách chọn màu sơn nhà theo phong thủy</a>
                            </h4>
                            <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                            <a href="#" target="_blank" class="detail">XEM CHI TIẾT
                                <i class="fa fa-chevron-right" aria-hidden="true"></i>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-blog">
                        ...
                        <div class="content-box">
                            <h4>
                                <a href="#" target="_blank" class="title-blog">Bảo trì hệ thống cấp thoát nước cho căn hộ</a>
                            </h4>
                            <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                            <a href="#" target="_blank" class="detail">XEM CHI TIẾT
                                <i class="fa fa-chevron-right" aria-hidden="true"></i>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="box-blog">
                        ...
                        <div class="content-box">
                            <h4>
                                <a href="#"  target="_blank"class="title-blog">Bảo trì hệ thống máy lạnh</a>
                            </h4>
                            <p>Chúng tôi sẽ chăm sóc lo lắng cho ngôi nhà của bạn như chính ngôi nhà của mình.</p>
                            <a href="#" target="_blank" class="detail">XEM CHI TIẾT
                                <i class="fa fa-chevron-right" aria-hidden="true"></i>
