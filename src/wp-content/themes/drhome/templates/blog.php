                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="box-blog">
                            <div class="content-img">
                                ...
                                <a href="<?php echo get_permalink($post->ID); ?>" target="_blank" title="<?php echo $post->post_title; ?>"><!-- change 28/10/2019 -->
                            ...
                            <div class="content-box">
                                <h4>
                                    <a href="<?php the_permalink(); ?>" class="title-blog" target="_blank" title="<?php echo $post->post_title; ?>"><?php echo excerpt($post->post_title, 12, '...'); ?></a>
                                </h4>
                                <p>
                                <?php 
                                    $tex_limit = getTextLang(60, 40);
                                ?>
                                <?php echo excerpt(get_the_excerpt(),$tex_limit); ?>
                                </p>
                                <a href="<?php the_permalink(); ?>" target="_blank" class="detail">
