<?php
//* Template Name: Dự án hoàn thành
get_header();
?>
<div class="main">
    ...
    <section class="tab-service package">
        <div class="container">
            <div class="title">
               <h2><?php echo get_field('title_dich_vu');?></h2>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="box-package">
                            ...
                            <div class="box-title">
                                ...
                                <a href="<?php echo get_permalink(); ?>"  target="_blank" class="detail">
    ...
    <section class="library-img">
        <div class="container">
            ...
            <div class="see-all">
                <?php if(ICL_LANGUAGE_CODE=='vi'): ?>
                    <a href="<?php echo get_page_link(16);?>" target="_blank">
                        XEM TẤT CẢ
                        <i class="fa fa-chevron-right" aria-hidden="true"></i>
                    </a>
                <?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
                    <a href="<?php echo get_page_link(2365);?>" target="_blank">
                        SEE ALL
                        <i class="fa fa-chevron-right" aria-hidden="true"></i>
                    </a>
                <?php endif;?>
