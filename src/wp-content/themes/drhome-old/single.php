...
get_header(); 
$page_id_vi = get_page_by_path( 'tin-tuc', OBJECT, 'page' )->ID;
$page_id_eb = get_page_by_path( 'news', OBJECT, 'page' )->ID;
                            ...
                            <?php if(!empty($tags = get_field('hash_tags'))): ?>
                                <div class="post-hash-tags">
                                    <ul>
                                        <?php   
                                            foreach($tags as $tag){
                                                echo '<li class="post-hash-tags--name"><a href="'.$tag['tag']['url'].'" target="'.$tag['tag']['target'].'">#'.$tag['tag']['title'].'</a></li>';
                                            }
                                        ?>
                                    </ul>                                
                                </div>
